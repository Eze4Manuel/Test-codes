...
const PersonalInfo = () => {
  ...
  return (
    <AuthLayout
      meta={
        <Meta
          title="Personal Info | Sanctuary Keepers Unit Lead"
          description="Your personal information as a Sanctuary Keepers unit lead in CCI."
        />
      }
    >
      <div className="grid w-full gap-10">
        <ProfileDetails membershipClass serviceUnit="Sanctuary Keepers" />
