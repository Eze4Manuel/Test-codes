...
const PersonalInfo = () => {
  ...
  return (
    <AuthLayout
      meta={
        <Meta
          title="Personal Info | Ambience Unit Lead"
          description="Your personal information as an ambience unit lead in CCI."
        />
      }
    >
      <div className="grid w-full gap-10">
        <ProfileDetails membershipClass serviceUnit="Ambience" />
