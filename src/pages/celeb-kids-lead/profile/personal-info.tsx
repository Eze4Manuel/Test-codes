...
const PersonalInfo = () => {
  ...
  return (
    <AuthLayout
      meta={
        <Meta
          title="Personal Info | Celeb Kids Unit Lead"
          description="Your personal information as a Celeb Kids unit lead in CCI."
        />
      }
    >
      <div className="grid w-full gap-10">
        <ProfileDetails membershipClass serviceUnit="Celeb Kids" />
